...
export default [
    ...
    resources: [
      {
        ...
        desc: 'Partenza per Assisi da Piazza XXVI Giugno – Chiusi (Si) alle ore 15.00. Visita libera della Basilica di San Francesco, luogo sacro per eccellenza, poiché qui sono conservate e custodite le spoglie del celebre santo. La Basilica è costituita da un complesso di immenso valore artistico, sia per le strutture architettoniche sia per i preziosi affreschi e decori interni, che vede integrarsi in armonia due differenti edifici. L’insieme vede due chiese sovrapposte: la Basilica Superiore di aspetto gotico, luminosa e slanciata, e la Basilica Inferiore più bassa ed austera, cui si accede attraverso un portale in stile gotico.'
      },
      {
        desc: 'A queste si aggiunge la Cripta con la Tomba di San Francesco, il cuore pulsante delle Basiliche; dal 2000 è stata inserita nella lista dei Patrimoni dell’Umanità dell’Unesco, assieme ad una serie di siti francescani dell’area umbra. A fine visita ci sposteremo a Cannara, luogo amatissimo da San Francesco, dove lui parlava con gli uccellini. Ci attende una simpatica APERICENA a bordo piscina per festeggiare il Ferragosto sotto le stelle.'
      },
      {
        desc: 'Fantasia di sfoglia calda - Verdure pastellate - Insalata di riso - Melone e rucola -'
      },
      {
        desc: 'Fantasia di sfoglia calda - Verdure pastellate - Insalata di riso - Melone e rucola -'
      },
      {
        desc: 'Farro in salsa primavera Flan di parmigiano - Cipolle fritte - Verdure di stagione in pinzimonio -'
      },
      {
        desc: 'Salumi - Formaggi'
      },
      {
        desc: 'Torta alle mandorle - Dolce allo jogurt - Delizia al cioccolato'
      },
      {
        desc: 'Acqua e vino'
      },
      {
        desc: 'Dopo cena inizio del viaggio di rientro in sede. Arrivo e fine dei nostri servizi.'
      },
    ],
    extra: [
      {
      ...
      {
        detail: 'QUOTA DI PARTECIPAZIONE',
        number: '€40.00'
      }
    ],
    footer: [
      {
        title: 'La quota comprende:',
        desc: 'viaggio in autobus gran turismo, pedaggi autostradali, autista a nostro carico, doppio autista ove previsto dalla normativa vigente in materia di sicurezza, parcheggi, ticket d’ingresso in città d’arte ove previsti, apericena di Ferragosto bevande comprese, assicurazione RC Generali.'
      },
      {
        title: 'La quota non comprende:',
        desc: 'ingressi durante le visite, mance, escursioni facoltative non citate da programma, extra di carattere personale e tutto quanto non espresso alla voce “la quota comprende”.'
      }
    ]
  },
  {
    ...
    footer: [
      {
        title: 'La quota comprende:',
        desc: 'viaggio in bus gran turismo, visita con guida privata del giardino di Villa Origo a La Foce, biglietto ingresso al giardino, aperi-cena con piatti tipici della tradizione toscana bevande comprese, assicurazione RC EUROPASSISTANCE.'
      },
      {
        title: 'La quota non comprende:',
        desc: 'extra di carattere personale, tutto quanto non espresso alla voce “la quota comprende”.'
      }
    ]
  },
  {
    ...
    resources: [
      {
        ...
        desc: 'Trasferimento in bus gran turismo per Roma Fiumicino; formalità d’imbarco e partenza del volo notturno diretto a Urgench.'
      },
      {
        day: '22 agosto 2018 - Urgench -Khiva',
        desc: 'Arrivo di mattina presto, ritiro del bagaglio ed incontro con rappresentante locale per il trasferimento in hotel a Khiva (distanza 30 km). Sistemazione nelle camere riservate e la prima colazione.  Inizio delle visita della città, che molti considerano la più bella dell’Asia Centrale, la più isolata delle oasi carovaniere uzbeke sulla Via della Seta. Pranzo in ristorante tipico “Yasaulbashi”. Proseguimento delle visite. Cena in hotel. Pernottamento.'
      },
      {
        day: '23 agosto 2018 - Bukhara',
        desc: 'Prima colazione in hotel. Partenza per Bukhara attraverso uno dei deserti più grandi del mondo il Kizil Kum, il Deserto Rosso. Si percorreranno più volte alcuni tratti della Grande Via della Seta. Pranzo in una località del deserto. Arrivo a Bukhara nel tardo pomeriggio per la sistemazione in hotel. Cena e pernottamento.'
      },
      {
        day: '24 agosto 2018 - Bukhara',
        desc: 'Prima colazione in hotel. Intera giornata di visite della città, in cui la grandiosità degli antichi edifici ricorda periodi importanti della sua turbolenta storia di invasioni e battaglie contro Arabi, Mongoli e contro Tamerlano. Verso la fine del XVI secolo fu la capitale dello stato chiamato Khanato di Bukhara e la città vide fiorire il commercio assumendo l’aspetto che mantenne fino alla rivoluzione del 1919. Pranzo in ristorante. Cena folkloristica in caravanserraglio Nodirdevonbeghi accompagnata da balli e musiche tradizionali. Pernottamento.'
      },
      {
        day: '25 agosto 2018 - Shakhrisabz - Samarcanda',
        desc: 'Prima colazione in hotel. Partenza per Samarcanda via Sharkhrisabz. Pranzo in ristorante locale. Visita del villaggio di Kesh che dette i natali a Tamerlano, il quale una volta salito al potere, lo trasformò in una città monumentale, la cui fama competeva con quella della vicina Samarcanda. Partenza per la sistemazione in hotel a Samarcanda. Cena in hotel. Pernottamento.'
      },
      {
        day: '26 agosto 2018 - Samarcanda',
        desc: 'Prima colazione in hotel. Intera giornata dedicata alla visita di Samarcanda: specchio del mondo, giardino dell’anima, gioiello dell’Islam, perla dell’Est, centro dell’Universo, sono alcuni dei nomi dati a questa città su cui aleggia ancor oggi l’atmosfera delle leggende di “Mille e una notte”. Situata nell’oasi del fiume Zarafshan, nel cuore della regione centroasiatica, la famosa Samarcanda è una delle più antiche città del pianeta, con più di 2500 anni di storia. Grazie ai suoi capolavori architettonici ed archeologici, detta “la città delle cupole azzurre” è stata inserita nella lista dei Patrimoni dell’Umanità dall’UNESCO. Pranzo in ristorante locale. Pomeriggio proseguimento delle visite. Cena e pernottamento.'
      },
      {
        day: '27 agosto - Samarcanda - Tashkent',
        desc: 'Prima colazione in hotel. Partenza per Tashkent. Visita della capitale uzbeca: città più importante dell’Asia Centrale, nodo commerciale dell’intero Turkestan. Oggi conta oltre 3 milioni di abitanti e rappresenta la quarta città dell’ex Unione Sovietica. Meritano una visita Piazza dell’Indipendenza, la stupenda metropolitana e la parte antica della città, con il complesso Khast Imam, che nasconde l’unico tesoro del mondo islamico, l’antico Corano di Osman del VII secolo. Pranzo in ristorante. Cena e pernottamento in hotel.'
      },
      {
        day: '28 agosto 2018 - Tashkent - Roma Fiumicino',
        desc: 'Prima colazione in hotel. Tempo a disposizione per visite individuali. Trasferimento in aeroporto, disbrigo delle formalità e partenza del volo di linea diretto in Italia. Pranzo libero. Arrivo nel pomeriggio a Roma Fiumicino. Ritiro del bagaglio e proseguimento in bus per Chiusi. Fine dei nostri servizi.'
      }
    ],
    extra: [
      {
      ...
      {
        detail: 'VISTO INGRESSO UZBEKISTAN - obbligatorio',
        number: '65.00'
      },
      {
        detail: 'PACCHETTO INGRESSO DURANTE TUTTO IL TOUR',
        number: '115.00'
      }
    ],
    footer: [
    ...
    resources: [
      {
        ...
        desc: 'Partenza per il porto di Ancona per il disbrigo delle formalità d’imbarco e la partenza con traghetto notturno diretto a Spalato. Sistemazione in cabine con servizi privati. Cena libera a bordo. Pernottamento.'
      },
      {
        day: '20 settembre 2018 - Spalato - Podgorica',
        desc: 'Colazione a bordo (una bevanda calda ed una brioche). Arrivo al porto di Spalato. Operazioni di sbarco e partenza per il Montenegro (km 350). Il Paese più giovane d’Europa, nel cuore dei Balcani, è un piccolo scrigno della natura e della storia. Appena 100 chilometri da Nord a Sud, ma vanta ben 117 spiagge, il fiordo più meridionale d’Europa ed antichi borghi di pietra, memoria della Repubblica di Venezia. Sosta lungo il viaggio per il pranzo pic-nic. Arrivo in hotel per la sistemazione nelle camere riservate. Tempo a disposizione per una prima visita libera della città. Cena e pernottamento.'
      },
      {
        day: '21 settembre 2018 - Bocche di Cattaro - Budva',
      ...
      {
        day: '22 settembre 2018 - Lago di Scutari - Skadarsko Jeerzo',
      ...
      {
        day: '23 settembre 2018 - Cetinje - Spalato',
      ...
      {
        day: '24 settembre 2018 - Porto di Ancona',
        desc: 'Colazione a bordo (una bevanda calda ed una brioche). Arrivo al porto di Ancona. Operazioni di sbarco. Inizio del viaggio di rientro in sede. Fine dei nostri servizi.'
      }
    ],
    extra: [
      {
  ...
  },
  {
    ...
    footer: [
      ...
      {
        title: 'La quota non comprende:',
        desc: 'pasti non citati da programma, escursioni facoltative non citate da programma, extra di carattere personale e tutto quanto non espresso alla voce “la quota comprende”.'
      }
    ]
  },
  {
    ...
    footer: [
      ...
      {
        title: 'La quota non comprende:',
        desc: 'pasti non citati da programma, ingressi durante le visite, escursioni facoltative, extra di carattere personale e tutto quanto non espresso alla voce “la quota comprende”.'
      }
    ]
  },
  {
    id: 'roma',
    cover: 'https://images.unsplash.com/photo-1509024644558-2f56ce76c490?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=dc2d65e06878d1320a8f986b29bfc6ae&auto=format&fit=crop&w=1650&q=80',
    name: 'Roma',
    days: '14 ottobre 2018',
    desc: 'Mamma mia!',
    ...
    footer: [
      ...
      {
        title: 'La quota non comprende:',
        desc: 'pasti non citati da programma, mance, escursioni facoltative non citate da programma, extra di carattere personale e tutto quanto non espresso alla voce “la quota comprende”.'
      }
    ]
  },
  {
    ...
    resources: [
      {
        ...
        desc: "Trasferimento in bus gran turismo per l’aeroporto di partenza. Disbrigo delle formalità d’imbarco e partenza del volo diretto a Praga. Arrivo ed incontro con nostro rappresentante locale per il trasferimento in centro città. Pranzo libero. In base all’orario di arrivo prima visita a piedi della città. Cena e pernottamento."
      },
      {
        day: '02 novembre 2018 - Praga',
        desc: "Prima colazione in hotel. Incontro con la guida per la visita del centro storico della città; inizieremo così ad apprezzare lo splendore di una delle città più belle d’Europa. Abbiamo preparato per voi un percorso di visite strutturato in più giorni per dare la possibilità di conoscere ogni aspetto storico, culturale e sociale di una capitale in continuo movimento e ricca di storia. Pranzo libero. Pomeriggio dedicato alla visita del Quartiere Ebraico, conosciuto come Josefov, è uno dei più antichi e famosi centri ebraici di tutta l’Europa Centrale. Oltre al Vecchio Cimitero, sono le sinagoghe i monumenti più significativi della Città Ebraica. Questi edifici non sono solo monumenti importanti dal punto di vista architettonico, ma documentano lo sviluppo storico e le singole epoche della vita ebraica nella città.  Cena e pernottamento."
      },
      {
        day: '03 novembre 2018 - Praga',
        desc: "Prima colazione in hotel. Incontro con la guida e, con una breve passeggiata, ci sposteremo sulla collina della città che ospita il Castello e la stupenda Cattedrale. Sosta per la visita. A piedi, passeggiando lungo una delle zone più panoramiche della città, arriveremo sullo stupendo Ponte Carlo, forse uno dei punti più fotografati dai turisti di tutto il mondo. Pranzo libero. Il pomeriggio invece sarà dedicato alla zona della Malà Strana (Parte Piccola), con il suo aspetto barocco e rinascimentale che ancora oggi conserva. Dal quel momento la zona ha vissuto una sorta di immobilità che l’ha resa come un angolo al di fuori del tempo; non ci sono auto, i turisti raramente arrivano in questo angolo così nascosto e tutto il quartiere assume un aspetto quasi magico. Cena e pernottamento."
      },
      {
        day: '04 novembre 2018 - Praga - aeroporto in Italia',
        desc: "Prima colazione in hotel. Tempo libero a disposizione fino al momento del trasferimento in aeroporto per il disbrigo delle formalità d’imbarco e la partenza del volo diretto in Italia. Pranzo libero. Arrivo in Italia e proseguimento in bus gran turismo per il rientro in sede. Fine dei nostri servizi."
      }
    ],
    extra: [
      {
  ...
  },
  {
    ...
    resources: [
      ...
      {
        desc: "Coloratissima e contraddittoria Miami è una metropoli tropicale che alterna quartieri di gran lusso e zone off limits, spiagge da sogno e giungle urbane. Da qualche anno cerca di darsi un suo contegno intellettuale, si è riempita di gallerie d’arte e di studi di design."
      },
      {
        desc: "Una nuova generazione di giovani creativi, nata da un mix di razze e di culture, ha trasformato la città in un polo di attrazione internazionale: la musica, la moda, l’arte hanno qui un posto d’onore. La capitale della Florida è oggi “la scena del glamour”, elegante e bella ha imparato a giocare la carta del tropical chic e della mondanità. Da non perdere!"
      },
      {
        day: '18 novembre 2018 - Roma Fiumicino - Miami',
        desc: "Trasferimento per l’aeroporto di partenza. Volo di linea per Miami. All’arrivo trasferimento in centro città per la sistemazione in hotel."
      },
      {
        day: '19 novembre 2018 - Miami',
        desc: "Prima colazione in hotel. Facoltativo: giro città di Miami."
      },
      {
        day: '20 novembre 2018 - Miami',
        desc: "Prima colazione in hotel. Facoltativo: Everglades National Park"
      },
      {
        day: '21 novembre 2018 - Miami',
        desc: "Prima colazione in hotel."
      },
      {
        day: '22 novembre 2018 - Miami',
        desc: "Prima colazione in hotel. Facoltativo: Key West"
      },
      {
        day: '23 novembre 2018 - Miami - Roma Fiumicino',
        desc: "Prima colazione in hotel. Nel tardo pomeriggio trasferimento in aeroporto. Volo di linea notturno per Roma Fiumicino."
      },
      {
        day: '24 novembre 2018 - Roma Fiumicino',
        desc: "Arrivo in mattinata a Roma Fiumicino, trasferimento per il rientro in sede. Fine dei nostri servizi."
      }
    ],
    extra: [
      {
  ...
  },
  {
    ...
    resources: [
      ...
      {
        desc: "Poi c’è il Ponte di Brooklyn, il primo costruito in acciaio, che collega il quartiere di Brooklyn all’isola di Manhattan, dal famoso skyline di grattacieli. Il più famoso tra quelli storici è sicuramente l’Empire State Building, ma inconfondibili sono anche le architetture del Chrysler Building e del Palazzo di Vetro dell’ONU. Il museo più antico e prestigioso è invece il Metropolitan Museum of Art, ma imperdibili sono anche le visite alle collezioni del MoMa(Museum of Modern Art) e del Guggenheim Museum."
      },
      {
        desc: "Altri luoghi divenuti ormai icone del paesaggio newyorkese sono Times Square, che di sera si accende delle mille luci delle insegne, e il Central Park, il grande polmone verde di Manhattan dove gli abitanti si ritrovano tra gli scoiattoli e i laghetti per divertirsi, rilassarsi e fare sport all’aria aperta. Anche se ferita al cuore dall’attentato terroristico dell’11 settembre 2001, che ha distrutto un altro simbolo della città, le Torri Gemelle, la metropoli ha mostrato una decisa forza di reazione."
      },
      {
        day: '11 dicembre 2018 - Roma Fiumicino - New York',
        desc: "Trasferimento in bus privato per l’aeroporto di partenza. Volo di linea per New York. All’arrivo trasferimento in centro città per la sistemazione in hotel."
      },
      {
        day: '12 dicembre 2018 - New York',
        desc: "Prima colazione in hotel. Facoltativo: visita orientativa di Manhattan."
      },
      {
        day: '13 dicembre 2018 - New York',
        desc: "Prima colazione in hotel. Facoltativo: visita degli altri quartieri di New York, Bronx, Queens, Brooklyn - Visita notturna della città che non dorme mai."
      },
      {
        day: '14 dicembre 2018 - New York',
        desc: "Prima colazione in hotel. In serata trasferimento in aeroporto per il volo di rientro in Italia."
      },
      {
        day: '15 dicembre 2018 - Roma Fiumicino',
        desc: "Arrivo in mattinata a Roma Fiumicino, trasferimento per il rientro in sede. Fine dei nostri servizi."
      }
    ],
    extra: [
    ...
    footer: [
      ...
      {
        title: 'La quota non comprende:',
        desc: 'Escursioni facoltative: Visita di Manhattan (€50.00), Tour dei contrasti (€50.00), New York di notte (€50.00)'
      }
    ]
  },
  {
