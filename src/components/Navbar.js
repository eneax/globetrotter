  ...
  return (
    <nav className="db dt-l w-100 border-box pa3 ph5-l">
      ...
      <div className="db dtc-l v-mid w-100 w-75-l tc tr-l">
        ...
        <Link to='/group' className="link dim dark-gray f6 f5-l dib mr3 mr4-l" title="Viaggi di Gruppo">Viaggi di Gruppo</Link>
        ...
        <Link to='/contact' className="link dim dark-gray f6 f5-l dib" title="Contatti">Contatti</Link>
      </div>
    </nav>
  )
}
