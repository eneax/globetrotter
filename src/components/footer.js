...
const Footer = () => (
	<FooterWrapper>
		<small>© {new Date().getFullYear()} <b>AL CENTRO DEL MONDO</b> s.r.l.</small>

    <SocialLink href="https://www.facebook.com/Al-Centro-del-Mondo-Viaggi-e-Turismo-113138121866/" aria-label="facebook">
